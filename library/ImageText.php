...
class ImageText
{
     ...
     * @return $this
     */
    public function text($text, $options = [], &$boundary = [])
    {
        ...
        $options = $this->fitTobounds($text, $options);
     ...
     * @return integer
     */
    protected function fitToBounds($text, $options)
    {
        extract($options);
        ...
        do {
            $wrapped = $this->wrap($text, $options);
     ...
     * @return String
     */
    protected function wrap($text, $options, $output = '')
    {
        extract($options);
