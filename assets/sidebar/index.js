...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"modeAuto":"BygBjwYpqPpeTZbVCcRT","thumbnailImage":"g4qkvGu7xkyoImxRZ6GR","thumbnailIcon":"ipnonin6Xj5A9QU3K38L"});
...
const SharingImageSidebar = ({
  ...
  const updateFieldset = (key, value) => {
    setFieldset(prevFieldset => ({ ...prevFieldset,
      [key]: value
    }));
  };
  /**
  ...
  const displayModeAutoIcon = () => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Dashicon, {
      icon: "awards",
      className: _styles_module_scss__WEBPACK_IMPORTED_MODULE_10__["default"].modeAuto,
      title: title
    });
  };
  /**
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.Flex, {
    direction: 'column',
    gap: 2,
    style: {
      position: 'relative'
  ...
  }), postMeta[meta.source]?.mode === 'auto' && displayModeAutoIcon(), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_7__.SelectControl, {
    value: template,
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_5__.registerPlugin)('sharing-image-sidebar', {
  render: () => {
    ...
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SharingImageSidebar, { ...params
    }));
  }
});
})();
